...
- op "add_view" creates a UX view; requires "table", "name", "viewType". Optional: position, groupAggregate, showIf, displayName, icon. For a view, "showIf" is its Show-if formula and "displayName" its Display name. Always pick a fitting "icon".
