...
- TABLE views, which columns show + their order: "columnOrder" automatic|manual, and "viewColumns" = the EXISTING columns to show, in display order. Providing "viewColumns" implies manual. Only the listed columns are shown; the rest are hidden.
