...
export function buildManifest(target: Target) {
  const base: any = {
    ...
    version: "1.3.0",
    description: "AI assistant for the AppSheet editor: build columns/views/actions, back up config. Session connectors for claude.ai and Gemini Gems (no API key).",
